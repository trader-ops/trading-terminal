...
const DAY_TRADE_PIPELINE = [
    ...
    },
    {
        id: "trade_6",
        seq: 6,
        title: "TRADE #6: $4,400.00 ROUND LEVEL CONFIRMATION SELL",
        badge: "✅ SMASHED +150 PIPS",
        action: "▼ STRONG SELL (SHORT)",
        isBear: true,
        entryPrice: 4400.00,
        slPrice: 4404.50,
        ...
        zoneMin: 4399.00,
        zoneMax: 4401.00,
        session: "ROUND NUMBER RE-TEST",
        reason: "$4,400 Round Level Confirmation Rejection",
        ...
        winProb: 91,
        probGrade: "A+ PRIME",
        summary: "👑 TARGET SMASHED: Dropped from $4,400.00 down to $4,385.00 (+150 Pips Profit Secured)."
    },
    {
        id: "trade_7",
        seq: 7,
    ...
    },
    {
        ...
        winProb: 89,
        probGrade: "A INSTITUTIONAL",
        summary: "👑 TARGET SMASHED: Rebounded from $4,395.00 up to $4,408.00 (+130 Pips Profit Secured)."
    },
    {
        id: "trade_11",
        seq: 11,
...
var UNIFIED_TRADES_STORAGE_KEY = "trading_terminal_real_trades_v29_master";
...
var DEFAULT_REAL_SESSION_TRADES = [
    ...
    },
    {
        ...
        direction: "SELL",
        entry: "$4,400.00",
        sl: "$4,404.50 (Moved to Breakeven)",
        tpTarget: "$4,385.00 (TP1 Smashed)",
        exitPrice: "$4,385.00 (Target Smashed)",
        status: "WON",
        winProb: 91,
        probGrade: "A+ PRIME",
        pips: 150,
        ...
        pnlUsd: 30.00,
        rMultiple: 3.3,
        confluence: "$4,400 psychological level rejection with 15M candle body close confirmation. Expansion down to $4,385.00 (+150 Pips).",
        proof: "✅ TP1 SMASHED AT $4,385.00: +150 Pips secured (+$30.00 at 0.02 Lot).",
        winReason: "Round number ($4,400) par blind entry ke bajaye 15M candle close confirmation ka wait kiya jis se market ne +150 pips clean deliver kiye.",
        disciplineRule: "Patience pay off: Confirmation candle ke baad trade execute ki."
    },
    {
        id: "real_trade_7",
        category: "SETUP",
    ...
    },
    {
        ...
        direction: "BUY",
        entry: "$4,395.00",
        sl: "$4,390.50 (Moved to Breakeven)",
        tpTarget: "$4,408.00 (TP1 Smashed)",
        exitPrice: "$4,408.00 (TP1 Smashed)",
        status: "WON",
        winProb: 89,
        probGrade: "A INSTITUTIONAL",
        pips: 130,
        ...
        pnlUsd: 26.00,
        rMultiple: 2.9,
        confluence: "Deep Session Low clean-out with 1M bullish MSS absorption. Rebounded from $4,395.00 to $4,408.00 (+130 Pips).",
        proof: "✅ TP1 SMASHED AT $4,408.00: +130 Pips secured (+$26.00 at 0.02 Lot).",
        winReason: "Session low sweep ke baad institutional demand absorption hui aur price ne $4,408 target hit kiya.",
        disciplineRule: "Disciplined execution on 1M MSS confirmation."
    },
    {
        id: "real_trade_11",
        category: "SETUP",
    ...
    },
    {
        ...
        date: getLiveMarketDateString(),
        asset: "Gold (XAU/USD) SCALP BUY",
        session: "Floor Absorption Window • 25 Pip Scalp",
        direction: "BUY",
        entry: "$4,382.00",
        sl: "$4,379.50 (Moved to Breakeven)",
        tpTarget: "$4,388.00 Mid (TP2)",
        exitPrice: "$4,388.00 (TP2 Smashed)",
        status: "WON",
        winProb: 88,
        probGrade: "A+ SCALP",
        pips: 60,
        ...
        pnlUsd: 12.00,
        rMultiple: 2.4,
        confluence: "Range floor absorption tap at $4,382.00 with 1M lower wick rejection. Bounced cleanly to $4,388.00 equilibrium (+60 Pips).",
        proof: "✅ TP2 SMASHED AT $4,388.00: +60 Pips secured in 9 minutes (+$12.00 at 0.01 Lot).",
        winReason: "Range low par institutional wick absorption confirm hui aur price ne midpoint target hit kiya.",
        disciplineRule: "Support tap par strict rules ke mutabiq munafa lock kiya."
    }
];
